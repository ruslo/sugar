...
function(sugar_generate_warning_flag_by_name warning_flags warning_name)
  ...
  string(COMPARE EQUAL "conversion-loss-return" "${warning_name}" hit)
  if(hit)
    if(is_msvc)
  ...
  string(COMPARE EQUAL "expression-has-no-effect" "${warning_name}" hit)
  if(hit)
    if(is_msvc)
  ...
  string(COMPARE EQUAL "signed-unsigned-mismatch" "${warning_name}" hit)
  if(hit)
    if(is_msvc)
  ...
  string(COMPARE EQUAL "unreachable-code-simple" "${warning_name}" hit)
  if(hit)
    if(is_msvc)
